...
amrPipeline_pipeline = preprocessor_TrumpApproval |amr
amrPipeline_metrics = [mae]


amrPipeline = Pipeline(model = amrPipeline_pipeline, model_name ='AMRules'  , metrics_list = amrPipeline_metrics , name = "amrPipeline",y="five_thirty_eight",output_topic="amrPipeline")



# Output topics initialization

output_topic_amrPipeline = app.topic(amrPipeline.output_topic, value_deserializer="json")
...
sdf_amrPipeline = sdf_TrumpApproval.apply(amrPipeline.train_and_predict).to_topic(output_topic_amrPipeline)
...
def run_dash():
    ...
    def update_graph(n):
        ...
        amrPipeline.add_metrics_traces(fig = fig , row = 1, col = 1 ) 
    ...
    @dash_app.callback(
        Output(
            component_id='live-stats-amrPipeline', 
    ...
    def update_stats_amrPipeline(n):
        
        traces = []  
        
        amrPipeline.add_stats_traces(traces) 
