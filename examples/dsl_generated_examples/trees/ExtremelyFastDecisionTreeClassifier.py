...
input_topic = app.topic("Agrawal", value_deserializer="json")

output_topic = app.topic("ExtremelyFastDecisionTreeClassifier-results",
...
def train_and_predict(event):
    ...
    with open('ExtremelyFastDecisionTreeClassifier.pkl', 'wb') as model_file:
