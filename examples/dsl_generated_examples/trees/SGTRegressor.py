...
output_topic = app.topic("SGTRegressor-results",
...
model = (
    ...
    tree.SGTRegressor(feature_quantizer=tree.splitter.DynamicQuantizer(
        std_prop=0.1,
    ),
...
def train_and_predict(event):
    ...
    with open('SGTRegressor.pkl', 'wb') as model_file:
