...
input_topic = app.topic("SEA", value_deserializer="json")

output_topic = app.topic("HoeffdingAdaptiveTreeClassifier-results",
...
def train_and_predict(event):
    ...
    with open('HoeffdingAdaptiveTreeClassifier.pkl', 'wb') as model_file:
